...
#####################################################################################################
# Create public IP
resource "azurerm_public_ip" "public_ip_lb01" {
    name                = "demo-aud-lb01_public-ip"
...
resource "azurerm_network_interface" "new_terraform_lb01_nic01" {
    ...
    ip_configuration {
        ...
        public_ip_address_id           = azurerm_public_ip.public_ip_lb01.id
    }
